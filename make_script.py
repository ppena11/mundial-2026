...
AI_SYSTEM = (
    ...
    "infografía del cuadro en el video, así que dila una única vez, NUNCA al inicio y NUNCA como última frase: "
    "después de ella deben venir el cierre y el CTA (esa cola le da aire a las escenas finales). "
