...
Alimenté mi IA del Mundial con datos en tiempo real… sin pagar nada 🆓⚽ Y cuando una página de pago me bloqueó, la IA encontró otra gratis. Pronósticos diarios gratis en mi Substack (link en bio). #Mundial2026 #IA #parati #NoCode #DatosGratis

## 🎞️ Texto en pantalla / b-roll (concreto, con assets que ya tienes + 2 capturas)

| Seg | Voz dice… | Visual exacto |
|---|---|---|
| **0-3s** | "…una IA sin datos es como un cerebro sin ojos…" | `matchday.png` con el texto **"DATOS DEL MUNDIAL. GRATIS."** quemado |
| **~3-15s** | "…los saco de ESPN, gratis y en vivo…" | 🎥 **screen-recording del sitio de ESPN** (Mundial) → corta a `matchday.png` (que se vea la nota de bajas) |
