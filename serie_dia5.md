# Serie "Cómo lo construí en un día" — Post 5 (TikTok · CIERRE)

> La VOZ (ElevenLabs): el video se narra con un clon de IA de mi propia voz, sin grabar nada cada día.
> Gancho META (la voz que escuchas ES el clon) + cierre de serie que apunta al lanzamiento (11 jun).

---

## 🎬 Gancho (texto en pantalla, 0-3s)
**ESTA VOZ… ES IA.**
*(quemado sobre el reel `matchday.mp4` reproduciéndose / una onda de audio)*
...
La voz que narra mis videos del Mundial no la grabo: es un clon de IA de mi propia voz 🎙️🤖 La cloné una vez y narra para siempre. El Mundial empieza el 11. Pronósticos gratis en mi Substack (link en bio). #Mundial2026 #IA #parati #ElevenLabs #NoCode

## 🎞️ Texto en pantalla / b-roll (concreto)

| Seg | Voz dice… | Visual exacto |
|---|---|---|
| **0-3s** | "…esta voz… no la grabé hoy…" | el reel `matchday.mp4` o una **onda de audio** + texto **"ESTA VOZ… ES IA."** |
| **~3-15s** | "…cloné mi voz una sola vez, unos minutos de audio…" | 🎥 **screen-recording de ElevenLabs**: tu voz clonada en la lista de Voices |
| **~15-28s** | "…escribe el guion y se lo entrega a mi voz, que narra sola…" | `voiceover.txt` en pantalla → ElevenLabs generando → la **onda de audio** |
...
## 💬 Comentario fijado (para generar debate + lanzar el producto)
> "El Mundial arranca el 11. ¿Quién crees TÚ que será campeón? Mi IA ya tiene su favorita 👇"

---
*Cierre de la serie "Cómo lo construí en un día". A partir del 11 de junio: pronóstico diario + cierre con aciertos y fallos. La serie demostró el "cómo"; el Mundial demuestra el "funciona".*
